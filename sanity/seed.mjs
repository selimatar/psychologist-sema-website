...
const documents = [
  ...
  },
  {
    ...
    title: 'Aşırı Düşünme',
    description:
      'Zihninizde dönüp duran düşünce döngülerini yavaşlatmak ve karar anlarında takılıp kalmadan ilerleyebilmek için araçlar.',
    icon: 'overthinking',
    tint: 'terracotta',
  ...
  },
  {
    ...
    title: 'Erteleme',
    description:
      'Harekete geçmenizi engelleyen kaygı ve mükemmeliyetçiliğin altındaki nedenleri anlamak, küçük ve sürdürülebilir adımlarla ilerlemek.',
  ...
  {
    _id: 'service-emotional-regulation',
    _type: 'service',
    title: 'Duygu Düzenleme',
    description:
      'Yoğun duygularla baş etmenin ve onları bastırmadan ya da onlara kapılmadan taşımanın yollarını birlikte keşfetmek.',
